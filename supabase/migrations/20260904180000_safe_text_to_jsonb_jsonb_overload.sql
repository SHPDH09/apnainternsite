-- safe_text_to_jsonb(text) exists on RDS but many RPCs call safe_text_to_jsonb(jsonb)
-- e.g. resolve_login_email during student login by registration / roll number.
-- Add jsonb overload and ensure text implementation is present.
