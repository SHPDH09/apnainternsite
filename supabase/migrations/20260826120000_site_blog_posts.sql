-- Site blog posts (mirrors aws/scripts/55-rds-site-blog-posts.sql)
...
CREATE INDEX IF NOT EXISTS idx_site_blog_posts_active_sort
  ON public.site_blog_posts (is_active, is_featured DESC, sort_order ASC, published_at DESC NULLS LAST, created_at DESC);
