...
-- Reuse permanent purge for Student Data Upload bulk delete (any student id, not upload-tagged only).
...
-- Staff access removal: revoke roles + optional full purge when row exists in admin_staff.
