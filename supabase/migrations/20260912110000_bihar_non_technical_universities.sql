...
-- Insert-only: skips names that already exist in public.universities.
...
-- Ensure each listed university has a non-engineering config row (courses/colleges added in Admin).
