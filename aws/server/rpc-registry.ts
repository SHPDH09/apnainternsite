...
export const RPC_REGISTRY: Record<string, RpcDef> = {
  ...
  account_may_use_company_login: { args: ["check_email"], auth: "public" },
  ...
  admin_approve_company_partner: { args: ["p_company_id", "p_reviewer_id"], auth: "admin" },
  admin_reject_company_partner: { args: ["p_company_id", "p_reason"], auth: "admin" },
  company_complete_hiring: { args: ["p_job_id", "p_remark"], auth: "auth" },
  ...
  link_referral_partner_portal: {
    args: ["target_user_id", "p_partner_id", "partner_email", "partner_full_name", "p_login_secret"],
    auth: "admin",
  },
  ...
  admin_ensure_dashboard_service_keys: { args: [], auth: "admin" },
  admin_ensure_project_report_templates: { args: [], auth: "admin" },
