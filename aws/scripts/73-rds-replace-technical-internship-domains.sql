-- Replace technical internship domains with the final 55-domain engineering catalog.
-- Removes legacy software-dev style domains; keeps non-tech domains untouched.
